...
import { Leaf, Menu, X, Home, LayoutDashboard, Users, LogOut, LogIn, Bookmark } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
          <motion.div
            ...
            className="w-9 h-9 rounded-xl eco-gradient-primary flex items-center justify-center"
          >
