        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <motion.div whileHover={{ scale: 1.05, boxShadow: '0 8px 30px hsl(142 71% 45% / 0.3)' }} whileTap={{ scale: 0.97 }}>
              <Link
                to="/dashboard"
                className="relative inline-flex items-center justify-center gap-2 px-8 py-4 rounded-2xl eco-gradient-primary text-primary-foreground font-semibold text-lg shadow-lg overflow-hidden group"
              >
                {/* Shine effect */}
